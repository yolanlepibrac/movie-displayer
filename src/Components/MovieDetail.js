...
export default class MovieDetail extends Component {
  ...
  displayTrailer = () => {
    if (isMobile) {
      ...
      return <iframe style={{width:"100%", height:400}} src={this.props.urlMovie} frameborder="0" allowfullscreen="1"></iframe>
    }
    ...
    if (this.props.filmDetail != undefined) {
      return (
        <div style={{width:'100vw', display:'flex', flexDirection:"row", overflow:"hidden", height:"75vh"}}>
          ...
          <div style={{width:'60%',marginLeft:10, padding:20, overflowY:"auto", overflowX:"hidden", display:"flex", flexDirection:"column",  alignItems:"center", }}>
            <div style={{  width:"100%", textAlign:"justify", marginTop:20}}>
              <div>{this.displayTrailer()}</div>

              <div style={{marginTop:10, marginBottom:10, width:"100%"}} >{film.overview}</div>
